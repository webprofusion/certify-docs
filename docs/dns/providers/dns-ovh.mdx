...
<img alt="Filling the OVH form to create credentials" src={useBaseUrl('assets/ovh-api-keys-creation-form.png')} />

- Validate with the 'Create Keys' button
- Copy down the Application Key, Application Secret and Consumer Key.

<img alt="Save the OVH form to get credentials" src={useBaseUrl('assets/ovh-api-keys-creation-result.png')} />
...
<img alt="OVH Credentials on Certify" src={useBaseUrl('assets/ovh-api-certify.png')} />
