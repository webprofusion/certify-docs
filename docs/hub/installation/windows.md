...
You can download the latest **alpha test** version [7.0.2.25-alpha.08 : Released 2025/06/05](https://certifytheweb.s3.amazonaws.com/downloads/archive/beta/hub/CertifyMgmtHubSetup.exe) - this is intended for test evaluation and not for production use, as subsequent updates may including breaking changes.
